...
export type TopItem = { establecimientoId?: number; circuitoId?: number; establecimiento?: string; circuito?: string; votos: number };
export type ProgresoItem = { establecimientoId?: number; circuitoId?: number; establecimiento?: string; circuito?: string; mesasEscrutadas: number; mesasTotales: number; porcentaje: number; faltan: number };
