import { MesaVoteSummary } from "../mesa-summary/components/types";


const ordenPreferido = ["DIPUTADOS", "SENADORES"];

export function buildChartData(resultados: MesaVoteSummary["resultados"]) {
...
export function getCategoriasUnicas(resultados: MesaVoteSummary["resultados"]) {
...
export function getTiposEspecialesUnicos(
  especiales: MesaVoteSummary["votosEspeciales"]
) {
  const set = new Set<string>();
