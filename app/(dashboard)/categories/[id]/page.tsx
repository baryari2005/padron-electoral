...
export default function CategoryIdPage({ params }: { params: { id: number } }) {
  ...
  const handleUpdated = () => {
    toast.success(formatApiMessage("success.categoryUpdated"));
  ...
  return (
    <div className="max-w-2xl mx-auto p-8 bg-white dark:bg-secondary rounded-lg shadow-md">
      ...
      <div className="flex items-center mb-2 space-x-2">
        ...
        <h2 className="text-2xl font-semibold">Editar Cargo Político</h2>
      </div>
      <p className="text-muted-foreground mb-6">Modificar una Cargo Político existente en el sistema</p>
