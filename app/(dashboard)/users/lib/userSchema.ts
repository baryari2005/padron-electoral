...
export const userSchema = (isEdit: boolean) =>
  z.object({
    id: isEdit ? z.string().min(1, formatMessage("ID es obligatorio")) : z.any().optional(),
    ...
    escuelasIds: z.array(z.number()).default([]), // 👈 importante
  });

// (opcional) puedes quitar este export para evitar confusiones
