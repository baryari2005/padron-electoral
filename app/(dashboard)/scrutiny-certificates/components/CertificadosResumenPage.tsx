...
import { CertificadoLoader } from "../components/CertificadoForm/";
...
export default function CertificadosResumenPage() {
  ...
  console.log("🧩 CertificadoResumen se está montando");

  useEffect(() => {
    setLoadingResumen(true);
    axios
      .get("/api/scrutiny-certificates/summary")
      .then((res) => {
        const items = res.data?.items ?? [];
        console.log("📦 summary recibidas", items);
  ...
  if (loadingResumen) return (<CertificadoLoader />);
